...
function footer () {
    ...
    return(
        <div className="footer">
            <a href="https://github.com/TimotheeRoy" target="_blank">
            ...
            <a href="https://www.linkedin.com/in/timoth%C3%A9e-roy-39752b271/" target="_blank">
            ...
            <a href="../assets/TimotheeRoy.pdf" target='_blank' >
            <img width="48" height="48" src="https://img.icons8.com/ios-glyphs/48/summary-list.png" alt="summary-list"/>
            </a>
        </div>
        )
}
