...
function Project({ name, description, repo, demo, isDark }: ProjectProps) {
    return (
        <div className="project-container">
            <h2>
                {name}{" "}
                <a
                    className={isDark ? "repoLink-dark" : "repoLink"}
                    href={repo}
                    target="_blank"
                >
                    <svg
